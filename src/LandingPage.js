...
const LandingPage = () => {
  ...
  return (
    <div>
      <nav>
        <p className="sitename" onClick={() => scrollToSection('index-section')}>VisionBotix</p>
        <p className="menu" onClick={() => scrollToSection('about-us')}>About Us</p>
        <p className="menu" onClick={() => scrollToSection('services')}>Services</p>
        <p className="menu" onClick={() => scrollToSection('work-process')}>Work Process</p>
      ...
      <div className="section" id="index-section">
        <div className="title">
          <p>Vision</p>
          <p>Botix</p>
        </div>

        <a href="https://github.com/Afu001/visionbotix" target="_blank" className="button first"><button>View Source</button><span></span></a>

        <a href="https://www.youtube.com/watch?v=ca1QVEuwEzk" target="_blank" className="button sec"><button>Watch Video</button><span></span></a>

        <a href="https://www.linkedin.com/in/khawaja-aswad/" target="_blank" className="button third"><button>Connect</button><span></span></a>
      </div>
      ...
      <svg className="top-right" width="219" height="147" viewBox="0 0 219 147" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="69.4713" y="-91.84" width="180.485" height="180.485" transform="rotate(20.2832 69.4713 -91.84)" stroke="white" strokeOpacity="0.1" />
      </svg>
      ...
      <div className="section" id="work-process">
        <h1>Work Process</h1>
        <p>Our work process is streamlined to ensure the best outcomes...</p>
      </div>
    </div>
  );
};
